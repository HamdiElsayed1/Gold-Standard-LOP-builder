...
This is the **executable** version of the whiteboard: **[`../../Workflow.jpeg`](../../Workflow.jpeg)** and **[`../01-workflow-and-sketch/workflow-from-sketch.md`](../01-workflow-and-sketch/workflow-from-sketch.md)**. Follow in order; keep the tracker honest.
...
| **Information gathering** | Drop or link sources under the pursuit folder (see [`../04-templates-and-setup/next-steps.md`](../04-templates-and-setup/next-steps.md)). Voice → notes file; partner/CST/RFP/gold/market each dated or versioned. |
...
Stub: [`../04-templates-and-setup/source-manifest.template.md`](../04-templates-and-setup/source-manifest.template.md). Full table: copy from [`../../../Fleur/lop-build-tracker.template.md`](../../../Fleur/lop-build-tracker.template.md) into your pursuit as `lop-build-tracker.md`.
...
See **[`../04-templates-and-setup/next-steps.md`](../04-templates-and-setup/next-steps.md)** — copy one skeleton into [`../../pursuits/`](../../pursuits/), add `lop-build-tracker.md`, then return to **section 1** of this playbook.
