...
**How to run the workflow without code:** follow **[`../02-operating-playbook/playbook-from-sketch.md`](../02-operating-playbook/playbook-from-sketch.md)** (step-by-step in Cursor + Markdown).
